...
```
Also you could create your list of ip or domain (FQDN) addresses each on the new line to exclude from the result files. It could be reached by set `$excludeFile` variable or by `--exclude=` argument: 
```bash
